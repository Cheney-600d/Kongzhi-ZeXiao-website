...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '.toy-coin-orb-b{width:220px;height:220px;right:-72px;bottom:-80px;background:linear-gradient(135deg,#B8A4D8,#78DCE8);animation:toyCoinFloat 8s ease-in-out infinite reverse;}',
      ...
      '.toy-coin-kicker{display:inline-flex;align-items:center;gap:8px;padding:7px 13px;border-radius:999px;background:#FFE4ED;color:#B71C1C;font-size:13px;font-weight:900;letter-spacing:.08em;}',
      '.toy-coin-card h2{margin:16px 0 10px;font-size:clamp(28px,5vw,48px);line-height:1.08;color:#B71C1C;text-shadow:none;font-weight:900;letter-spacing:-.04em;}',
      ...
      '.toy-coin-steps span{display:inline-flex;align-items:center;padding:7px 11px;border-radius:999px;background:linear-gradient(135deg,#FFF1F5,#F3E8FF);color:#B71C1C;font-size:13px;font-weight:900;border:1px solid rgba(251,114,153,.18);}',
      ...
      '.toy-follow-status.warn{background:#FFE4ED;color:#B71C1C;}',
      '.toy-coin-progress-wrap{padding:16px;border-radius:20px;background:rgba(184,164,216,.14);border:1px solid rgba(184,164,216,.28);margin-bottom:16px;}',
      ...
      '.toy-coin-progress-text strong{font-size:20px;color:#B71C1C;}',
      '.toy-coin-progress{height:12px;background:#E8E0E8;border-radius:999px;overflow:hidden;box-shadow:inset 0 2px 6px rgba(0,0,0,.08);}',
      '.toy-coin-progress span{display:block;width:0%;height:100%;border-radius:999px;background:linear-gradient(90deg,#FB7299,#B8A4D8,#78DCE8);transition:width .35s ease;}',
      ...
      '.toy-coin-video{position:relative;display:flex;flex-direction:column;gap:10px;min-height:145px;padding:16px;border-radius:20px;background:#fff;border:1px solid rgba(184,164,216,.35);box-shadow:0 8px 24px rgba(184,164,216,.18);}',
      ...
      '.toy-coin-btn-primary{background:linear-gradient(135deg,#B71C1C,#FB7299);color:#fff;box-shadow:0 10px 24px rgba(183,28,28,.26);}',
      '.toy-coin-btn-ghost{background:#fff;color:#B71C1C;border:1px solid rgba(183,28,28,.18);}',
