...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '.toy-coin-card{position:relative;overflow:auto;max-height:calc(100vh - 48px);border:1px solid rgba(255,255,255,.5);border-radius:30px;background:linear-gradient(145deg,rgba(255,255,255,.94),rgba(255,247,252,.9));box-shadow:0 28px 80px rgba(17,24,39,.38);padding:34px;color:#17191d;}',
      ...
      '.toy-coin-progress{height:12px;background:#deded8;border-radius:999px;overflow:hidden;box-shadow:inset 0 2px 6px rgba(0,0,0,.08);}',
      ...
      '.toy-coin-video-title{font-weight:900;line-height:1.45;color:#17191d;}',
